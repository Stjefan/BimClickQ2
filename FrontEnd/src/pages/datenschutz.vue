<!-- datenschutz.vue -->
<!-- Vue/Quasar-Komponente für Datenschutzerklärung -->
<template>
  <q-page padding>
   <q-card style="min-width: 80%" class="my-card bg-teal-1 text-black q-pa-md">
      <q-img
        ...
        class="my-img"
      />
      <q-markdown no-breaks ref="markdown" :src="markdownDatenschutz">
      </q-markdown>
    </q-card>
  </q-page>
</template>
...
import markdownDatenschutz from "../markdown/bim-click-datenschutz.md"; // Markdown File mit BIM.click Impressum
export default {
  name: "Datenschutz", // Vue Component Name - ACHTUNG - dabei beachten:
  ...
  data: function() {
    return {
      ...
      markdownDatenschutz: markdownDatenschutz // NEU: Für QMarkdown - hält den Markdown für die Dokumentation aus oben importiertem File
    };
  }
};
</script>
