/* eslint-disable */
// Node Module für Microsoft OneDrive Fle Picker
// Kopiert von https://js.live.net/v7.2/OneDrive.js
// Siehe https://docs.microsoft.com/en-us/onedrive/developer/controls/file-pickers/js-v72/open-file?view=odsp-graph-online
// und https://github.com/OneDrive/onedrive-api-docs/issues/864
// ACHTUNG: Erfordert JS-Format vor Build!
// ACHTUNG: Wirft zahlreciche eslint Fehler beim Compile, deshalb /* eslint-disable */
            ...
            var g = (function() {
              ...
              e.prototype.launch = function(e) {
                ...
                return this.buildOauthPromise(e)
                  .then(function(e) {
                    return e && e.type === "cancel" ? e : l.buildPickerUI(e);
                  })
                  .then(function(e) {
                    ...
                    e.type ||
                      p
                        ...
                        .exposeToPublic();
                    if (e.type === "switch") return l.launch(!0);
                    if (e.type === "success") {
                      for (
                      ...
                      if (
                        !t.needAPICall() ||
                        (i && t.accessToken.toLowerCase() === "rps")
                      ) {
              ...
              e.prototype.buildPickerUI = function(e) {
                ...
                return ((this.loginHint = r).apiEndpoint === n.default.graph_odb
        ...
        function(e, t, r) {
          !(function(e, t, d, c, p, f, i, n, o, a) {
            ...
            t.loginHintExpired = function() {
              ...
              return new Date().getTime() - e.timeStamp > 36e5;
            };
          ...
          !(function(e, t, r, a, u, s, l, d, c, p, i, f) {
            ...
            t.buildOauthConfig = function(t, e) {
              ...
              var i = t.scopes.map(function(e) {
                  return (
                    e +
                    (e.indexOf("Files.") > -1 && t.needSharePointPermission
                      ? ".All"
                      : "")
                  );
                }),
              ...
              i = (function() {
                ...
                n.prototype.parseAdvancedOptions = function(e) {
                  if (e.advanced) {
                    ...
                    e.advanced.scopes &&
                      (typeof e.advanced.scopes === "string"
                    ...
                    typeof e.advanced.isConsumerAccount === "boolean" &&
                  ...
                  if (e) {
                    ...
                    if (o) {
                      this.needSharePointPermission = !(
                        o.length === 1 && o[0].toLowerCase() === "onedrive"
                      );
          ...
          !(function(e, t, o, a, r, s, u, l) {
            ...
            var i = (function(n) {
              ...
              function e(e) {
                ...
                t.commandMode === null && (t.commandMode = void 0);
                t.qosExtraData === null && (t.qosExtraData = void 0);
                e.advanced &&
        ...
        function(e, t, r) {
          !(function(e, t, i, r) {
            ...
            t.deserializeJSON = function(e) {
              ...
              (typeof t === i.default.TYPE_OBJECT && t !== null) || (t = {});
              return t;
            };
        ...
        function(e, t, r) {
          !(function(e, t, i, o, a, s, u) {
            ...
            t.isPathFullUrl = function(e) {
              return e.indexOf("https://") === 0 || e.indexOf("http://") === 0;
            };
            ...
            function f(e, t) {
              for (var r = 0, i = (t = t || [l, d]); r < i.length; r++) {
                var n = i[r];
                if (e.toUpperCase().indexOf(n) === 0) return;
              }
              o.throwError(
                new s.default(
            ...
            var c = new RegExp("^([a-fA-F0-9]){16}$"),
              r = (function() {
                    ...
                    this._request.upload.onprogress = function(e) {
                      if (e.lengthComputable) {
                        var t = {
                          ...
                          totalBytes: e.total,
                          progressPercentage:
                            e.total === 0 ? 0 : (e.loaded / e.total) * 100
                        };
                ...
                o.prototype._callFailureCallback = function(e, t) {
                  ...
                  this._failureCallback(this._request, e, e === -2);
                };
        ...
        function(L, e, t) {
          ...
          (r = this),
            (i = function() {
              ...
              function m(e) {
                if (e && typeof e === "object" && e.constructor === this) {
                  return e;
                }
                var t = new this(y);
                O(t, e);
              ...
              function M(e, t) {
                ...
                if (r(t)) {
                  ...
                  if (this.length === 0) U(this.promise, this._result);
                  else {
                    this.length = this.length || 0;
                    this._enumerate();
                    this._remaining === 0 && U(this.promise, this._result);
                  }
                } else {
                  C(
                    this.promise,
              ...
              M.prototype._settledAt = function(e, t, r) {
                ...
                this._remaining === 0 && U(i, this._result);
              };
